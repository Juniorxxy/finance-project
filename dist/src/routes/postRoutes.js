...
router.post("/posts", authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const safePost = Object.assign(Object.assign({}, newPost), { user: newPost.user
                ? {
                    id: newPost.user.id,
                ...
                : undefined, recipient: newPost.recipient
                ? {
...
router.get("/", authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const safePosts = posts.map((post) => (Object.assign(Object.assign({}, post), { user: post.user
                ...
                : undefined, recipient: post.recipient
                ? {
